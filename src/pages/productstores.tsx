            ...
            <div className="flex gap-2 mt-4 md:mt-0">
              {store.whatsapp && (
                <a href={store.whatsapp.startsWith('http') ? store.whatsapp : `https://wa.me/${store.whatsapp}`} target="_blank" rel="noopener noreferrer">
                  <Button size="icon" variant="secondary" className="rounded-full hover:bg-[#25D366] hover:text-white transition-colors">
              ...
              {store.facebook && (
                <a href={store.facebook} target="_blank" rel="noopener noreferrer">
                  <Button size="icon" variant="secondary" className="rounded-full hover:bg-[#1877F2] hover:text-white transition-colors">
              ...
              {store.instagram && (
                <a href={store.instagram} target="_blank" rel="noopener noreferrer">
                  <Button size="icon" variant="secondary" className="rounded-full hover:bg-[#E4405F] hover:text-white transition-colors">
              ...
              {store.tiktok && (
                <a href={store.tiktok} target="_blank" rel="noopener noreferrer">
                  <Button size="icon" variant="secondary" className="rounded-full hover:bg-black hover:text-white transition-colors">
