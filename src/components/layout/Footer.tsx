...
import LogoImg from "@/assets/bazzarna_logo_2.png";
import {
    Accordion,
    AccordionContent,
    AccordionItem,
        ...
        <footer className="bg-slate-950 text-slate-200 mt-auto border-t border-slate-800">
            <div className="container py-8 md:py-12">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div className="md:hidden col-span-1 space-y-4 pt-2">
                        {/* 1. Description instead of Logo & Socials */}
                        ...
                        <div className="grid grid-cols-2 gap-2 text-[10px] text-slate-400 border-y border-slate-800/50 py-2">
                            <div className="flex items-center gap-2">
                                <Phone className="h-3 w-3 text-primary" />
                                <span dir="ltr">{settings?.phone_number || "+213 555 123 456"}</span>
                            </div>
                            <div className="flex items-center gap-2 justify-end">
                                <span className="truncate max-w-[100px]">{settings?.email || "contact@bazzarna.com"}</span>
                                <Mail className="h-3 w-3 text-primary" />
                            </div>
                        </div>

                        {/* 3. Social Links - Keep only one set */}
