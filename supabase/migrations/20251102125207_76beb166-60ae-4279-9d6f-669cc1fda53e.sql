...
ADD COLUMN home_delivery_available boolean DEFAULT true,
ADD COLUMN desk_delivery_available boolean DEFAULT true,
ADD COLUMN home_delivery_price numeric DEFAULT 400,
ADD COLUMN desk_delivery_price numeric DEFAULT 300;
